...
\begin{lstlisting}
https://github.com/Vallidevibolla/Assignment-6/blob/main/code.py
\end{lstlisting}
%
and latex-tikz codes from
%
\begin{lstlisting}
https://github.com/Vallidevibolla/Assignment-6/blob/main/main.tex
\end{lstlisting}
%
Question taken from
\begin{lstlisting}
...
\end{lstlisting}
%
%https://github.com/gadepall/ncert/blob/main/linalg/inequalities/solutions/su2021/2/55/assignment_11.py
%
...
\begin{align}
    ...
    \end{align}
Thus the solution of the system of inequalities can be determined graphically, which is represented in Fig.     
\begin{figure}[ht]
    \centering
